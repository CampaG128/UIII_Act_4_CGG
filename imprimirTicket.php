...
$sentenciaProductos = $base_de_datos->prepare("SELECT p.id_producto, p.descripcion,p.producto_precio, pv.cantidad
FROM producto p
INNER JOIN 
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td class="producto"><?php echo $producto->descripcion;  ?> <strong>$<?php echo number_format($producto->producto_precio, 2) ?></strong></td>
